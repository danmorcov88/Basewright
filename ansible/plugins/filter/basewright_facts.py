...
lives in ``basewright.facts.collect``, where pytest covers it against the output of a real
host; a parser reachable only by running a playbook against a container is a parser nobody
tests the edges of.
...
from basewright.facts.collect import FILTERS
